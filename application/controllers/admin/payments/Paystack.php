...
class Paystack extends CI_Controller {
    ...
    public function paystack_standard() {
        ...
        //
        $this->load->view('payments/paystack/paystack_standard', $data);
    }
    ...
    public function paystack_inline() {
        ...
        //
        $this->load->view('payments/paystack/paystack_inline', $data);
    }
    ...
    public function success($ref) {
        ...
        //
        $this->load->view('/payments/paystack/success', $data);
    }
